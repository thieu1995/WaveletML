#!/usr/bin/env python
# Created by "Thieu" at 09:23, 25/05/2025 ----------%
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from sklearn.datasets import load_diabetes
from waveletml import Data, MhaWnnRegressor, CustomWaveletExpansionNetwork
...
model = MhaWnnRegressor(size_hidden=10, wavelet_fn="morlet", act_output=None,
                        ...
                        obj_name="MSE", seed=42, verbose=True, wnn_type=CustomWaveletExpansionNetwork,
