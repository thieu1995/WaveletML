#!/usr/bin/env python
# Created by "Thieu" at 22:51, 20/05/2025 ----------%                                                                               
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from sklearn.datasets import load_breast_cancer
from waveletml import Data, GdWnnClassifier, CustomWaveletSummationNetwork
...
model = GdWnnClassifier(size_hidden=10, wavelet_fn="morlet", act_output=None,
                        ...
                        valid_rate=0.1, seed=42, verbose=True, device=None, wnn_type=CustomWaveletSummationNetwork)
## Train the model
